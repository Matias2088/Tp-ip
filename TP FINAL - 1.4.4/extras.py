...
def dibujarFinal(screen,gano,palabraCorrecta,intentos,segundos):
    ...
    if gano:
        ...
        etiqueta = EtiquetaDelTexto(textoFinal, 1 , COLOR_FINAL,finalFont)
        #Dibuja el texto
        ...
        #Dibuja los textos
        mostrarTexto(screen,CENTRO_PANTALLA_X,200,EtiquetaDelTexto(textoFinal, 1 , COLOR_FINAL,finalFont))
        mostrarTexto(screen,CENTRO_PANTALLA_X,260,EtiquetaDelTexto(textoPalabraCorrecta, 1 , COLOR_FINAL,FuenteDelTexto(TAMANNO_LETRA)))
