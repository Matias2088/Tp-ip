...
def dibujarInicio(screen,rectangulo7):
    ...
    etiquetaJugar = EtiquetaDelTexto("Jugar",1,COLOR_BLANCO,defaultFont)
    etiquetaSalir = EtiquetaDelTexto("Salir",1,COLOR_BLANCO,defaultFont)
    etiquetaAcercaDe = EtiquetaDelTexto("Acerca De:",1,COLOR_BLANCO,defaultFont)
...
def dibujarFinal(screen,gano,palabraCorrecta,intentos,segundos):
    ...
    etiquetaGuardar = EtiquetaDelTexto("Guardar",1,COLOR_BLANCO,defaultFont)
